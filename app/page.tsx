    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(37,99,235,0.08),_transparent_30%),linear-gradient(135deg,_#f8fbff_0%,_#eef4ff_100%)] text-[#191919]">
      <header className="mx-auto flex w-full max-w-[1128px] items-center justify-between px-4 py-6">
        <Link href="/" className="flex items-center gap-2">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0A66C2] text-lg font-semibold text-white">in</div>
        ...
        <section className="grid gap-8 lg:grid-cols-[1.3fr_0.9fr] items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/signin">
                <Button className="min-w-[160px]">Connexion</Button>
              </Link>
              <Link href="/signup">
                <Button variant="outline" className="min-w-[160px] text-[#0A66C2] hover:bg-[#EBF4FD]">Inscription</Button>
              </Link>
            </div>
          ...
          <Card className="rounded-[24px] px-6 py-8 shadow-sm">
            ...
            <div className="mt-6 grid gap-3">
              <Link href="/signin" className="rounded-lg bg-[#0A66C2] px-4 py-3 text-sm font-semibold text-white text-center transition hover:bg-[#004182] block">Se connecter</Link>
              <Link href="/signup" className="rounded-lg border border-[#0A66C2] px-4 py-3 text-sm font-semibold text-[#0A66C2] text-center transition hover:bg-[#EBF4FD] block">Créer un compte</Link>
            </div>
          </Card>
        </section>
      </main>
